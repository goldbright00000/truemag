...
if($has_sidebar == 'full'){$has_sidebar = false;}
?>
...
//        }
		...
		<div class="hidden">
			...
			<span itemprop="rating" itemscope itemtype="http://data-vocabulary.org/Rating">      
				 <?php echo esc_html__('Rating:','cactusthemes');?> <span itemprop="value"><?php echo round($review_point/10,1) ?></span> / <meta itemprop="best" content="10"/>10
			</span>
		</div>
		<?php }else{ echo '>';} ?>

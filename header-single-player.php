...
//echo $diff=date_diff($date1,$date2);
                    ...
                    <div class="single_video_col">
                        <ul class="video_col_ul">
                            <li> <?php echo do_shortcode( '[post_view]' );   ?> View <i class="fa fa-eye"></i></li>
                            <li> <span><a href="#comment" id="cmt" ><i class="fa fa-comment"></i>  <?php echo  get_comments_number() ?></a></span></li>
                            <li><span class="like_up"><i class="fa fa-thumbs-up" aria-hidden="true"></i></span><span class="vote_dislike"><i class="fa fa-thumbs-down" aria-hidden="true"></i></span></li>
                             <?php
                   if(ot_get_option('video_report','on')!='off') { ?>
                    ...
                    <?php }
                   ?>
                            <li class="fb_lk"><span><?php echo do_shortcode( '[vifblike] ' ); ?></span></li>
                        </ul>
                        <ul class="video_col_right">
                            <div class="single_top_bar"></div>
                            <li><span><i class="fa fa-thumbs-up" aria-hidden="true"></i></span><?php echo $total_row;?></li>
                            <li><span><i class="fa fa-thumbs-down" aria-hidden="true"></i></span><?php echo $total_row1;?></li>
                        </ul>
                    </div>
                    <div class="box-m single_more">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        <div class="share_icons">
                            <ul class="iocns_add">
                                ...
                                <li><a  <?php if ( ! is_user_logged_in() ) { echo 'id="shareBtn"';} else{ echo 'id="shareBtn"'; }?>><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
                                <script>
                                ...
                                <li><a <?php if ( ! is_user_logged_in() ) {  echo'onclick="socal_media_share(); " href="mailto:premisetv@gmail.com?Subject=prime.tv&body='.get_permalink( get_the_ID() ).'"'; } else{ echo'onclick="socal_media_share(); " href="mailto:premisetv@gmail.com?Subject=prime.tv&body='.get_permalink( get_the_ID() ).'"'; }?>><i class="fa fa-envelope-square" aria-hidden="true"></i></a></li>


                    <li class="share_icn">
                         <a href="javascript:void(0);"> <i class="ficon-share"></i></a>
                    ...
                    <?php $id=get_the_ID();
                     $total_row = $wpdb->get_var("select count(*) FROM vote_system where post_id = '$id' and vote='like'");
                      $total_row1 = $wpdb->get_var("select count(*) FROM vote_system where post_id ='$id' and vote='dislike'");?>
                    <div class="wrap_gud_bad_bar wrap_gud_bad_bar2 col-md-6 col-sm-6">
                        <div class="countleft"><?php echo $total_row;?></div>
                        <div class="countright"><?php echo $total_row1;?></div>
                        <div class="voting_bar">
                            ...
                            <span class="vote_like"><?php echo $total_row;?></span>
                                ...
                                <progress id="goodProgress" class="goodP2" value="0" max="100">0%</progress>
                                <strong class="single_post_vs">
                                  <span class="leftCut"></span>
                                  VS
                                  <span class="rightCut"></span>
                                </strong>
                                <progress id="evilProgress" class="evilP2" value="0" max="100">0%</progress>
                ...
                <div class="s_share" style="display:none;"><?php  echo tm_social_share(); ?></div>

...
;(function($){
	$(document).ready(function() {
		...
		var evil = parseInt(jQuery('.vote_like_evil').text());
		var good = parseInt(jQuery('.vote_like').text());
		var evil2 = parseInt(jQuery('.wrap_gud_bad_bar2 .vote_like_evil').text());
		var good2 = parseInt(jQuery('.wrap_gud_bad_bar2 .vote_like').text());
		var total = evil + good;
		var total2 = evil2 + good2;
		if(evil/total*100>50){
			jQuery('#evilProgress').addClass('biggerHalf');
			jQuery('#goodProgress').removeClass('biggerHalf');
		}else{
			jQuery('#goodProgress').addClass('biggerHalf');
			jQuery('#evilProgress').removeClass('biggerHalf');
		}
		if(evil2/total2*100>50){
			jQuery('.evilP2').addClass('biggerHalf');
			jQuery('.goodP2').removeClass('biggerHalf');
		}else{
			jQuery('.goodP2').addClass('biggerHalf');
			jQuery('.evilP2').removeClass('biggerHalf');
		}

		jQuery('#goodProgress').attr('max', total).attr('value',good);
		jQuery('#evilProgress').attr('max', total).attr('value',evil);
		jQuery('.goodP2').attr('max', total2).attr('value',good2);
		jQuery('.evilP2').attr('max', total2).attr('value',evil2);
	}
	setProgressbar();
}(jQuery));

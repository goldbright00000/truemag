...
<div class="container main_wrap">
  ...
  <h2 style="font: 30px Myriad Pro;color: #23272C;margin-top: -18px; margin-left: -8px;font-weight:600;">Pledges</h2>
  ...
  <div class="tbl-wrap">
        ...
        <div style="float: left;border: 1px solid #F2F2F2;width:65%;height:64px;background-color:white;">
          <div style="height: 90px;">
              <div style="width: 100%;color: #23272c;font: 16px Myriad Pro bold;font-weight: 700;">
              ...
              <div style="width: 100%;font: 14px Myriad Pro bold;">
...
.table_1 th{ height: 63px;border-right:1px solid #ccc; padding:10px; background-color:#f8f8f8; color:#8E8E8E;font: 14px Myriad Pro bold;border-bottom: none !important;}
.actionBtn td {
